...
public class MainScreenController {
    ...
    private void updateStudentInfoDisplay() {
        if (studentInfo != null) {
            studentNameLabel.setText("Họ tên: " + studentInfo.getDisplayName());
    ...
    private void handleVirtualSchedule() {
        try {
            ...
            Stage stage = (Stage) virtualScheduleButton.getScene().getWindow();
            stage.setScene(new Scene(root, 1400, 900));
            stage.setTitle("Xếp lịch học ảo");
    ...
    private void handleViewScholarship() {
        try {
            ...
            Stage stage = (Stage) scholarshipButton.getScene().getWindow();
            stage.setScene(new Scene(root, 1400, 900));
            stage.setTitle("Danh sách học bổng dự kiến");
